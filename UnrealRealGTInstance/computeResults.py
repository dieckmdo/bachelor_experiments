...
fs.write('\n')
fs.write('\n')
fs.write(toLatexTab(objectList, accuracys, np.insert(precision_score(groundTruthList, predictionList, average=None), 17, 0), np.insert(recall_score(groundTruthList, predictionList, average=None), 17, 0), np.insert(f1_score(groundTruthList, predictionList, average=None), 17, 0), 4 ))
fs.write('\n')
fs.write(toLatexTab(objectList, accuracys, np.insert(precision_score(groundTruthList, predictionList, average=None), 17, 0), np.insert(recall_score(groundTruthList, predictionList, average=None), 17, 0), np.insert(f1_score(groundTruthList, predictionList, average=None), 17, 0), 2 ))
